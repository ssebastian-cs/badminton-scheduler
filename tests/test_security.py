"""
Unit tests for security utilities and validation.
"""
...
class TestSecurityValidator:
    ...
    def test_sanitize_string_length_limit(self):
        """Test length limiting in string sanitization."""
        long_string = "a" * 100
    ...
    def test_validate_against_injection_selective_checks(self):
        """Test selective validation checks."""
...
class TestRateLimiter:
    ...
    def test_rate_limiter_window_expiry(self):
        """Test that rate limiting window expires."""
        limiter = RateLimiter()
        identifier = "test_user"
    ...
    def test_rate_limiter_blocking(self):
        ...
        for i in range(15):  # More than 2x the limit of 5
            limiter.is_rate_limited(identifier, max_requests=5, window_minutes=60)
...
class TestSecurityFunctions:
    ...
    def test_sanitize_form_data_with_html(self, app_context):
        """Test form data sanitization with HTML content."""
        form_data = {
    ...
    def test_log_security_event(self, app_context):
        ...
        with app_context.test_request_context():
            with patch('app.security.current_app') as mock_app:
                ...
                # Log message should contain event details
    ...
    def test_validate_request_security_decorator(self, mock_request, app_context):
        """Test request security validation decorator."""
        # Mock request data
    ...
    @patch('app.security.request')
    def test_validate_request_security_blocked_ip(self, mock_request, app_context):
    ...
    @patch('app.security.request')
    def test_validate_request_security_rate_limited(self, mock_request, app_context):
